...
// a raster.
//
public class SafeLineOperation implements SafeOperationSingle {
    int x1;
    int x2;
    int y1;
    int y2;
    ...
    public SafeLineOperation(int x1, int x2, int y1, int y2, Color color) {
        this.x1 = x1;
        this.x2 = x2;
        this.y1 = y1;
        this.y2 = y2;
    ...
    public String toString() {
        return "line " + this.x1 + " " + this.x2 + " " + this.y1 + " " + this.y2;
    }
}
