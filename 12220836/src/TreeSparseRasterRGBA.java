...
//
public class TreeSparseRasterRGBA implements SingleLayer
{
    private int width;
    private int height;
    ...
    public RasterizedRGBIterator iterator() {
        return new MyMultiLayerRasterRGBAIter(null);
    }

    public MyPixelIterator getPixelIterator() {
        return new MyTreeSparseRasterRGBAPixelIterator(this);
    }
}
